...
//           }}
//         >
//       <div className="w-full max-w-4xl bg-transparent rounded-2xl max-h-[calc(100vh-120px)] overflow-auto mx-auto">
...
//           }}
//         >
//           <div className="w-full max-w-4xl bg-white rounded-3xl p-4 sm:p-6 shadow-2xl max-h-[calc(100vh-120px)] overflow-auto mx-auto border border-slate-100">
  ...
  return (
    <div className="space-y-8 relative">
      ...
      {showCalendarModal && (
        ...
        >
          {/* UPDATED: Changed container modal layout class configuration to allow custom cross-axis scroll maps */}
          <div className="w-full max-w-4xl bg-white rounded-3xl p-4 sm:p-6 shadow-2xl max-h-[calc(100vh-120px)] overflow-auto mx-auto border border-slate-100 touch-auto">
            <div className="flex flex-col gap-4">
              ...
              {/* UPDATED: Added fallback touch configurations inside the sub-container block */}
