...
import { countries } from "../utils/countries";
import { timezones, getTimezoneByCountry } from "../utils/timezoneList";
import { GLOBAL_MONTHS, getDaysInMonth, FINANCIAL_YEARS_BY_COUNTRY } from "../utils/dateHelpers"; // Added FINANCIAL_YEARS_BY_COUNTRY
import { useState, useRef, useEffect } from "react";
import { BiLoaderAlt } from "react-icons/bi";
import { FiSearch, FiChevronDown } from "react-icons/fi";
import { FiEye, FiEyeOff } from "react-icons/fi";
...
export default function Register() {
  ...
  // Timezone and Financial Year dynamic update logic handler
  const handleCountrySelect = (countryCode) => {
    ...
    // 2. Automatic Financial Year dates detection based on country code maps
    const fyDates = FINANCIAL_YEARS_BY_COUNTRY[countryCode.toUpperCase()] || FINANCIAL_YEARS_BY_COUNTRY["DEFAULT"];
