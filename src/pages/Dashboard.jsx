...
export default function Dashboard() {
  ...
  // NEW CODE (Helper function to convert country code to flag emoji)
  ...
  // NEW CODE
  // return (
  //   <div className="space-y-4 sm:space-y-6 pb-28 pt-2 max-w-7xl mx-auto text-left relative z-10 px-0.5 overflow-x-hidden">
  ...
  //             ).toLowerCase();
  //             return code !== "not-set" ? (
  //               <div className="inline-flex items-center justify-center overflow-hidden rounded-sm shadow-sm w-5 h-4 transform rotate-[-6deg]">
  //                 <img
  ...
  //           <span className="text-slate-400 font-normal text-xs sm:text-sm ml-1 truncate max-w-[150px] sm:max-w-none">
  ...
  return (
    <div className="space-y-4 sm:space-y-6 pb-28 pt-2 max-w-7xl mx-auto text-left relative z-10 px-0.5 overflow-x-hidden">
      <div className="flex items-start justify-between items-center">
        <div>
          <div className="flex items-center gap-1.5 tracking-tight">
            ...
            {profile?.homeCountry || profile?.nativeCountry ? (
              <div className="inline-flex items-center justify-center overflow-hidden rounded-sm shadow-sm w-[22px] h-[15px] transform -rotate-[6deg] bg-slate-100 select-none pointer-events-none mx-0.5">
                <img
                  src={`https://flagcdn.com/w40/${(profile.homeCountry || profile.nativeCountry).toLowerCase()}.png`}
                  alt="Flag"
          ...
          <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight leading-none mt-2">
            Your residency
          </h2>
        </div>
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-1.5 pt-4 pb-3 sm:p-4">
        <div className="flex flex-col items-center">
          ...
          <div className="flex items-center justify-center gap-10 sm:gap-16 mt-3 sm:mt-4 w-full max-w-sm">
        ...
        {recentTrips.length === 0 ? (
          ...
          <div className="space-y-3">
            {recentTrips.map((record) => (
              <div
                key={record.recordId}
                className="flex items-center justify-between p-2.5 px-3.5 bg-slate-50 rounded-2xl border border-slate-100"
              >
                ...
                <span className="text-xs sm:text-sm font-semibold text-slate-600 bg-white border border-slate-200 px-3 py-1 rounded-full">
                  {tripDuration(record)}
                </span>
              </div>
            ))}
...
//               ).toLowerCase();
//               return code !== "not-set" ? (
//                 // <div className="inline-flex items-center justify-center overflow-hidden rounded-[4px] border border-slate-100 shadow-[0_1px_2px_rgba(0,0,0,0.08)] bg-slate-50 w-[22px] h-[15px] mx-0.5 select-none pointer-events-none transform -rotate-[1deg]">
//                 <div className="inline-flex items-center justify-center overflow-hidden rounded-sm shadow-sm w-5 h-4 transform rotate-[-6deg]">
//                   <img
//                     src={`https://flagcdn.com/w40/${code}.png`}
//                     alt="Country Flag"
