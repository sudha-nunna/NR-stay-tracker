...
//             Travel Start Date
//           </label>
//           {/* relative wrapper added ONLY to host the fake placeholder overlay for Safari */}
...
//               className={`w-full box-border px-3 py-2 bg-slate-50 border text-slate-900 rounded-lg text-base focus:bg-white outline-none transition placeholder-slate-400 min-h-[42px] h-[42px] flex-none appearance-none ${
...
//               <span className="absolute inset-y-0 left-3 flex items-center text-base text-slate-400 pointer-events-none">
//                 Select start date
//               </span>
//             )} */}
//             {!watchedDepartureDate && (
//               <span className="absolute inset-y-0 left-3 hidden md:hidden max-md:flex items-center text-base text-slate-400 pointer-events-none">
//                 Select start date
//               </span>
//             )}
//           </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="min-w-0 w-full flex flex-col">
          ...
          <input
            ...
            style={{ colorScheme: "light", minWidth: 0 }}
            className={`w-full box-border px-3 py-2 bg-slate-50 border rounded-lg text-base focus:bg-white outline-none transition min-h-[42px] h-[42px] flex-none appearance-none ${
              watchedDepartureDate ? "text-slate-900" : "text-slate-400"
            } ${
              errors.departureDate
                ? "border-red-400 focus:ring-2 focus:ring-red-200"
                : "border-slate-200 focus:ring-2 focus:ring-blue-500"
        ...
        <div className="min-w-0 w-full flex flex-col">
          ...
          <input
            ...
            style={{ colorScheme: "light", minWidth: 0 }}
            className={`w-full box-border px-3 py-2 bg-slate-50 border rounded-lg text-base focus:bg-white outline-none transition min-h-[42px] h-[42px] flex-none appearance-none ${
              watchedArrivalDate ? "text-slate-900" : "text-slate-400"
            } ${
              errors.arrivalDate
                ? "border-red-400 focus:ring-2 focus:ring-red-200"
                : "border-slate-200 focus:ring-2 focus:ring-blue-500"
