...
//             fromCountry: rawHomeCountry,
//             toCountry: rawHomeCountry,
//             departureDate: cleanStartDate // Automatically shifts 01 Apr -> 01 Jan based on profile setup
//           })
//         ];

//         // Cascade country changes to subsequent tracking logs matching the older configuration
//         if (countryChanged) {
//           records.forEach((record) => {
//             if (
//               record.recordId !== initialHomeStayRecord.recordId &&
