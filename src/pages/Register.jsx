...
//   const periodStartValue = watch("residencyPeriodStart");
//   const passwordValue = watch("password");
//       {/* Visual Cover Panel (pinned on desktop while form scrolls) */}
//       <div className="hidden md:block md:w-1/2 sticky top-0 h-screen relative">
...
//   return (
//     <div className="flex min-h-[100dvh] w-full flex-col md:flex-row bg-white">
...
//       {/* Visual Cover Panel */}
//       <div className="hidden md:block md:w-1/2 min-h-[100dvh] relative">
//         <img
//           src={backgroundimg}
...
export default function Register() {
  ...
  // Watch form fields for inline validation and calculation criteria mapping
  const periodStartValue = watch("residencyPeriodStart");
  const passwordValue = watch("password");
  const selectedCountryCode = watch("homeCountry");
  const selectedTimezoneValue = watch("timezone");
  ...
  // Dynamic system filters based on input matching parameters
  const filteredCountries = countries.filter((c) => {
    const query = countrySearchQuery.toLowerCase().trim();
    return (
      c.name.toLowerCase().includes(query) ||
  ...
  // Country interaction macro mapping configurations
  const handleCountrySelect = (countryCode) => {
    setValue("homeCountry", countryCode, { shouldValidate: true });
    setCountryDropdownOpen(false);
    setCountrySearchQuery("");
  ...
  return (
    <div className="flex h-screen w-full flex-col md:flex-row bg-white overflow-hidden">
      ...
      <div className="flex flex-col w-full md:w-1/2 px-6 sm:px-8 lg:px-16 py-8 h-full overflow-y-auto no-scrollbar justify-center">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="relative" ref={countryRef}>
                  ...
                  {countryDropdownOpen && (
                    <div className="absolute z-50 left-0 right-0 mt-1.5 bg-white border border-slate-200 rounded-xl shadow-2xl overflow-hidden max-h-48 flex flex-col">
                      <div className="p-2 border-b border-slate-100 flex items-center gap-2 bg-slate-50">
                        <FiSearch className="text-slate-400 shrink-0 ml-1" />
                        <input
                          type="text"
      ...
      {/* RIGHT SIDE: Locked Cover Panel (Takes half width and remains completely static layout context) */}
      <div className="hidden md:block md:w-1/2 h-full relative overflow-hidden">
        <img
          ...
          alt="Residency Management"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-blue-700/60 via-purple-700/60 to-red-700/60 flex flex-col justify-center px-16 text-white h-full">
          <h2 className="text-3xl font-semibold leading-tight max-w-md">
            Track Your <span className="text-yellow-400">Global Stays</span>
          </h2>
          <p className="mt-4 text-lg text-white/90 max-w-md leading-relaxed">
